...
def startStream():
    os.system('LD_LIBRARY_PATH=/var/www/mjpg-streamer/mjpg-streamer-experimental/ /var/www/mjpg-streamer/mjpg-streamer-experimental/mjpg_streamer -o "output_http.so -w ./www" -i "input_raspicam.so" -fps 15 -vf -hf')
